...
class StaticBuilder(object):
    ...
    # UPLOAD - Meat of the Matter
    def upload(self, paths_in, path_out, force, metadata, name, recursive):
        """ Upload files to S3 """
